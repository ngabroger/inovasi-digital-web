...
// Call initializeAnimations when the page is loaded
document.addEventListener('DOMContentLoaded', initializeAnimations);

// Optional: reinitialize animations on page change
document.addEventListener('pageChange', initializeAnimations);
